...
st.markdown(
    """
        ...
        Write down the name of a company and our Agent will do the resarch for you.
    """
)
...
class CompanyIncomeStatementTool(BaseTool):
    ...
    description = """
        ...
        You should enter a stock symbol.
    """
    args_schema: Type[CompanyIncomeStatementArgsSchema] = (
        CompanyIncomeStatementArgsSchema
    )
...
class CompanyStockPerformanceStatementTool(BaseTool):
    ...
    def _run(self, symbol):
        ...
        response = r.json()
        return list(response["Weekly Time Series"].items())[
            : min(len(response["Weekly Time Series"].items()), 200)
        ]
